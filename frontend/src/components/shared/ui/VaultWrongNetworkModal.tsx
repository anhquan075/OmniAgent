...
/// Modal shown when wallet is connected to an unsupported chain (not Ethereum Mainnet).
    ...
    <div className="modalBackdrop" role="dialog" aria-modal="true" aria-labelledby="networkModalTitle">
      <div className="modalCard">
        ...
        <p className="modalText">
          This app runs on <strong>Ethereum Mainnet (chain ID 1)</strong>. You are currently on{" "}
