  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card className="glass shadow-2xl border-cyber-purple/20 overflow-hidden group relative">
        <CardHeader className="pb-3 border-b border-white/5 bg-cyber-purple/5">
          <CardTitle className="flex items-center gap-2.5 text-white text-xs font-heading font-bold uppercase tracking-[0.2em]">
        ...
        <CardContent className="pt-4">
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div className="p-3 rounded-lg bg-white/5 border border-white/5">
              <span className="text-[10px] font-heading text-neutral-gray uppercase tracking-widest block mb-1">Checked</span>
              <p className="text-base font-mono text-white">{anomalyStats.totalChecked || 0}</p>
            </div>
            <div className="p-3 rounded-lg bg-white/5 border border-white/5">
              <span className="text-[10px] font-heading text-neutral-gray uppercase tracking-widest block mb-1">Anomalies</span>
              <p className="text-base font-mono text-cyber-purple">{anomalyStats.anomaliesDetected || 0}</p>
            </div>
            <div className="p-3 rounded-lg bg-white/5 border border-white/5">
              <span className="text-[10px] font-heading text-neutral-gray uppercase tracking-widest block mb-1">Last Z-Score</span>
              <p className="text-base font-mono text-white">{anomalyStats.lastZScore?.toFixed(2) || '—'}</p>
            </div>
            <div className="p-3 rounded-lg bg-white/5 border border-white/5">
              <span className="text-[10px] font-heading text-neutral-gray uppercase tracking-widest block mb-1">Mode</span>
              <p className="text-sm font-mono text-tether-teal">{anomalyStats.coldStartMode ? 'Cold' : 'Warm'}</p>
            </div>
          </div>
          <div className="mt-4 flex items-center gap-2.5 text-[10px]">
            <div className={`w-2 h-2 rounded-full ${anomalyStats.coldStartMode ? 'bg-yellow-500 animate-pulse' : 'bg-neon-green animate-pulse'}`}></div>
            <span className="text-neutral-gray uppercase tracking-wider font-medium">
      ...
      <Card className="glass shadow-2xl border-neon-green/20 overflow-hidden group relative">
        <CardHeader className="pb-3 border-b border-white/5 bg-neon-green/5">
          <CardTitle className="flex items-center gap-2.5 text-white text-xs font-heading font-bold uppercase tracking-[0.2em]">
        ...
        <CardContent className="pt-4">
          <div className="space-y-2.5">
            <div className="flex items-center gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
              <div className="w-7 h-7 rounded-full bg-tether-teal/20 flex items-center justify-center text-[10px] font-bold text-tether-teal shrink-0">1</div>
              <span className="text-[11px] text-white flex-1 font-medium">Hard Rules</span>
              <CheckCircleIcon className="w-4 h-4 text-neon-green shrink-0" />
            </div>
            <div className="flex items-center gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
              <div className="w-7 h-7 rounded-full bg-cyber-purple/20 flex items-center justify-center text-[10px] font-bold text-cyber-purple shrink-0">2</div>
              <span className="text-[11px] text-white flex-1 font-medium">Statistical Anomaly (Z/IQR)</span>
              <CheckCircleIcon className="w-4 h-4 text-neon-green shrink-0" />
            </div>
            <div className="flex items-center gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
              <div className="w-7 h-7 rounded-full bg-cyber-blue/20 flex items-center justify-center text-[10px] font-bold text-cyber-blue shrink-0">3</div>
              <span className="text-[11px] text-white flex-1 font-medium">AI Interpretation</span>
              <CheckCircleIcon className="w-4 h-4 text-neon-green shrink-0" />
            </div>
            <div className="flex items-center gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
              <div className="w-7 h-7 rounded-full bg-xaut-gold/20 flex items-center justify-center text-[10px] font-bold text-xaut-gold shrink-0">4</div>
              <span className="text-[11px] text-white flex-1 font-medium">Human Approval</span>
              <CheckCircleIcon className="w-4 h-4 text-neon-green shrink-0" />
            </div>
          </div>
          <div className="mt-4 grid grid-cols-3 gap-2 text-center">
            <div className="p-2 rounded bg-neon-green/10 border border-neon-green/20">
              <p className="text-xs font-mono font-bold text-neon-green">{governanceStats.autoApproved || 0}</p>
              <span className="text-[8px] text-neutral-gray uppercase block mt-0.5">Auto-Approve</span>
            </div>
            <div className="p-2 rounded bg-yellow-500/10 border border-yellow-500/20">
              <p className="text-xs font-mono font-bold text-yellow-500">{governanceStats.flaggedForReview || 0}</p>
              <span className="text-[8px] text-neutral-gray uppercase block mt-0.5">Flagged</span>
            </div>
            <div className="p-2 rounded bg-red-500/10 border border-red-500/20">
              <p className="text-xs font-mono font-bold text-red-500">{governanceStats.rejected || 0}</p>
              <span className="text-[8px] text-neutral-gray uppercase block mt-0.5">Rejected</span>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="glass shadow-2xl border-cyber-cyan/20 overflow-hidden group relative">
        <CardHeader className="pb-3 border-b border-white/5 bg-cyber-cyan/5">
          <CardTitle className="flex items-center gap-2.5 text-white text-xs font-heading font-bold uppercase tracking-[0.2em]">
        ...
        <CardContent className="pt-4">
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div className="p-3 rounded-lg bg-white/5 border border-white/5">
              <span className="text-[10px] font-heading text-neutral-gray uppercase tracking-widest block mb-1">Access Tier</span>
              <p className="text-sm font-mono text-cyber-cyan capitalize">{paymentStats.tier || 'anonymous'}</p>
            </div>
            <div className="p-3 rounded-lg bg-white/5 border border-white/5">
              <span className="text-[10px] font-heading text-neutral-gray uppercase tracking-widest block mb-1">x402 Revenue</span>
            ...
            <div className="p-3 rounded-lg bg-white/5 border border-white/5 col-span-2">
              <span className="text-[10px] font-heading text-neutral-gray uppercase tracking-widest block mb-1">Adaptive Polling</span>
      ...
      <Card className="glass shadow-2xl border-white/10 relative overflow-hidden flex flex-col">
        <CardHeader className="pb-3 border-b border-white/5">
          <CardTitle className="flex items-center gap-2.5 text-neutral-gray-light text-xs font-heading font-bold uppercase tracking-[0.2em]">
            <BrainCircuit className="w-4 h-4 text-tether-teal animate-pulse" />
            Agent Reasoning
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-6 flex-1 flex flex-col">
           <div className="p-4 sm:p-5 rounded-xl bg-white/5 border border-white/5 relative group">
              <div className="absolute -left-1 top-4 w-1 h-8 bg-tether-teal rounded-full shadow-glow-sm"></div>
              <p className="text-xs sm:text-sm text-white leading-relaxed font-mono italic opacity-90">
                "{stats?.lastReasoning || "Strategist is idling. Ready for link initialization..."}"
              </p>
              <div className="mt-5 flex items-center justify-between">
                <div className="flex items-center gap-2 opacity-50">
                  <div className="w-2 h-2 rounded-full bg-tether-teal animate-ping"></div>
               ...
               {stats.recentActions.slice(0, 5).map((action: any, idx: number) => (
                 <div key={idx} className="p-3 hover:bg-white/5 transition-colors group">
                    <div className="flex justify-between items-start mb-1.5 gap-2">
                      <span className="text-[10px] font-bold text-white uppercase tracking-wider group-hover:text-tether-teal transition-colors break-words">{action.title}</span>
                      <span className="text-[9px] font-mono text-neutral-gray uppercase whitespace-nowrap">{action.time}</span>
                    </div>
