  ...
  const inner = (
    <>
      ...
      <form
        ...
        ref={formRef}
        {...props}>
        <InputGroup className="overflow-hidden border-none border-transparent bg-transparent has-[[data-slot=input-group-control]:focus-visible]:ring-0 has-[[data-slot=input-group-control]:focus-visible]:border-transparent has-[[data-slot=input-group-control]:focus-visible]:shadow-none">{children}</InputGroup>
      </form>
    </>
  );
