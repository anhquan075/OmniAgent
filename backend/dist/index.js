...
const zk_proof_1 = __importDefault(require("./api/routes/zk-proof"));
...
app.route('/api/zk-proof', zk_proof_1.default);
...
if (isMain) {
    ...
    (0, node_server_1.serve)({
        ...
        if (process.env.WDK_TWAP_ORACLE_ADDRESS) {
            ...
            logger_1.logger.info('[TwapObserver] Disabled - WDK_TWAP_ORACLE_ADDRESS not set (TWAP deprecated)');
        }
        try {
