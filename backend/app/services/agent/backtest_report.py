    ...
    def build(ledger: dict[str, Any], proof_bundle: dict[str, Any]) -> dict[str, object]:
        ...
        return {
            ...
            "pnlSummary": {
                ...
                "confirmedTrades": int(pnl.get("confirmedTrades") or 0),
                "trackedTrades": int(pnl.get("trackedTrades") or 0),
                "missingPnlTrades": int(pnl.get("missingPnlTrades") or 0),
                "totalPnlUsd": float(pnl.get("totalPnlUsd") or 0),
                "notionalUsd": float(pnl.get("notionalUsd") or 0),
