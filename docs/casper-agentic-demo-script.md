...
13. Use the dashboard **Run cycle**, **Start**, and **Stop** actions to show the operator can trigger the live-gated agent without scripts. If any credential or live proof gate is missing, show the blocker rather than a substitute receipt. Do not describe x402 as paid evidence unless the public proof says `status: verified`.
