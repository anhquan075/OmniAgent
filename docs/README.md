...
This docs folder is Casper-only. It covers the buildathon runtime, proof model, dashboard, and submission flow for the Casper Agentic Buildathon.

## Core Docs

- [Architecture](ARCHITECTURE.md)
- [Railway Deployment](railway-deployment.md)
- [Finals ops runbook](finals-ops-runbook.md)
